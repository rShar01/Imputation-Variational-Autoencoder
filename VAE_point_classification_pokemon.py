...
if __name__ == "__main__":
    ...
    if args.display_errors:
        ...
        for i in range(3):
            ...
            print(f"\tpoint {i}:")
            print(f"\t\tlegendary loss:     {fraud_loss}")
            print(f"\t\tnot legendary loss: {not_fraud_loss}")
    ...
    print(f"Full model classification num on legendary points: {full_model_right_fraud_preds}")
